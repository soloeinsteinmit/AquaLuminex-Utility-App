...
public final class MessageToast {
    ...
    public static void makeText(Stage ownerStage, String toastMsg, int toastDelay, int fadeInDelay, int fadeOutDelay) {
        ...
        double centerX = screenBounds.getMinX() + (screenBounds.getWidth() - root.getMinWidth()) / 2;
        double centerY = screenBounds.getMinY() + (screenBounds.getHeight() - root.getMinHeight()) / 2;
